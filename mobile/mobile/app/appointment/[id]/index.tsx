  ...
  if (!appointment) {
    return (
      <View className="flex-1 bg-gray-100 justify-center items-center px-6">
        <Text className="text-base text-[#FF3B30] text-center">loading</Text>
      </View>
    );
  }
        ...
        <View className="mb-6">
          ...
          <View className="bg-white rounded-2xl p-5 shadow-sm">
            ...
            <View className="flex-row justify-between items-center py-3 border-b border-gray-100">
              ...
              <Text className="text-[15px] font-semibold text-[#2D3142]">
                {patientDetails?.medicalProfile?.gender || "Not specified"}
              </Text>
            </View>
            <View className="flex-row justify-between items-center py-3">
              <Text className="text-[15px] text-[#9E9E9E]">Age:</Text>
              <Text className="text-[15px] font-semibold text-[#2D3142]">
                {patientDetails?.medicalProfile?.dateOfBirth || "Not specified"}
              </Text>
            </View>
          </View>
        </View>
