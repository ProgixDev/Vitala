...
export const en: Record<string, string> = {
  ...
  'booking.customDuration': 'Custom',
  'booking.anyTime': 'Choose a time',
  ...
  'status.cancelVisit': 'Cancel this request',
  'status.cancelTitle': 'Cancel this request?',
  'status.cancelHold': 'No nurse has been paid and you haven\'t been charged. The hold on your card will be released.',
  'status.cancelRefund': 'This visit has already been paid. You\'ll be refunded in full — it can take 5–10 days to reach your card.',
  'status.cancelPlain': 'This request will be cancelled.',
  ...
  'service.category.elderly-care': 'Elderly care',
  'service.category.post-surgery': 'Post-surgery',
  'service.category.medication-administration': 'Medication',
  'service.category.vital-monitoring': 'Vital signs',
  'service.category.emergency': 'Emergency',
  // ---- nurse: job filters ----
  'nurse.filters.title': 'Job preferences',
  'nurse.filters.subtitle': 'Choose which requests reach you.',
  ...
  'nurse.filters.apply': 'Apply',
  'nurse.filters.button': 'Filters',
  'nurse.filters.unknownDistance': 'Distance unknown',
  'nurse.filters.locationOff': 'Turn on location to sort jobs by distance.',
  'nurse.filters.noMatch': 'No requests match your filters',
  'nurse.filters.noMatchDesc': 'Try widening your distance or adding more services.',
  'nurse.filters.emergencyNote': 'Emergencies always reach you, whatever your filters.',
  // ---- nurse: incoming request sheet ----
  'nurse.incoming.title': 'New visit request',
  'nurse.incoming.emergencyTitle': 'Emergency request',
  'nurse.incoming.homeVisit': 'Home visit',
  'nurse.incoming.slide': 'Slide to accept',
  'nurse.incoming.slideRelease': 'Release to accept',
  'nurse.incoming.accepting': 'Accepting…',
  'nurse.incoming.pass': 'Not this time',
  'nurse.incoming.tooLate': 'That job was just taken',
  ...
  'sos.family.title': 'Alert emergency contacts',
  ...
  'sos.type.family': 'Emergency contacts',
  ...
  'sos.needContactsDesc': 'You need at least one emergency contact to send an alert.',
  'sos.addContacts': 'Add contacts',
  'sos.dispatched': 'Help is on the way',
  'sos.familyAlerted': 'Your emergency contacts have been alerted',
